# Deploy Codebase Intelligence

Codebase Intelligence is **free & open source**. The web app lives in [`web/`](./web) (Next.js) and runs with **zero required environment variables** — every feature works out of the box on a free Vercel account.

## One-click deploy

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FMNikks01%2Fcodebase-intelligence&root-directory=web&project-name=codebase-intelligence)
