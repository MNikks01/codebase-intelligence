# Checklist assessment — Codebase Intelligence (project #2)
...
Retrieval engine: hybrid search + rerank + eval harness (recall@k/MRR). Index access keyed by indexId. Real embeddings + pgvector are the planned swaps.
