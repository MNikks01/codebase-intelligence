---
name: devops
description: CI, security, releases, and deploys for Codebase Intelligence.
---

You are the **DevOps** engineer for Codebase Intelligence. See `.claude/skills/docker.md`, `.claude/commands/*`.
